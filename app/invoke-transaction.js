...
logger.debug('######peerNames #############  "%s"', peerNames);
logger.debug('######chaincodeName #############  "%s"', chaincodeName);
logger.debug('######fcn #############  "%s"', fcn);
logger.debug('######Checking #############  "%s"', args);
logger.debug('######channelName #############  "%s"', channelName);
logger.debug('######tx_id #############  "%s"', tx_id);
...
logger.debug('######After request#############  "%s"', results);
